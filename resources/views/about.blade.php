  ...
  <section class="hero-banner-sm magic-ball magic-ball-banner" id="parallax-1" data-anchor-target="#parallax-1" data-300-top="background-position: 0px -80px" data-top-bottom="background-position: 0 100px">
    <div class="container">
      <div class="hero-banner-sm-content">
        <h1>About Us</h1>
        <p>Air seed winged lights saw kind whales in sixth best a dont seas dron image therefore fish all tree on</p>
      </div>
    </div>
  </section>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-5 col-md-6 align-self-center about-content">
          ...
          <p>Make she'd enraptured divided air. Whose tree that refill tone hath own upon them it multiply was blessed is lights build gathering thus day dominion thus locomotion air was created.</p>
  ...
  <section class="bg-gray section-padding magic-ball magic-ball-testimonial pb-xl-5">
    <div class="container">
      <div class="section-intro text-center pb-90px">
        ...
        <p>Fowl have fruit moveth male they're that place you'll lesser</p>
      </div>
      ...
      <div class="row">
        <div class="col-lg-6 col-xl-5 align-self-center mb-5 mb-lg-0">
          <div class="search-content">
            ...
            <p>Make she'd affected divided air. Whose tree that fill again tone hath own upon them it multiply was blessed is lights build gathering therefore day dominion therefore creep</p>
            <a class="button" href="#">Learn More</a>
          </div>
        </div>
